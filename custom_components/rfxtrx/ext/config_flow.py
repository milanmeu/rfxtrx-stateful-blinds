...
def update_device_options(device: dict[str, Any], user_input: dict[str, Any]) -> None:
    ...
    device[CONF_TILT_OPEN_ICON] = user_input.get(CONF_TILT_OPEN_ICON, DEF_TILT_OPEN_ICON)
    device[CONF_TILT_CLOSED_ICON] = user_input.get(CONF_TILT_CLOSED_ICON, DEF_TILT_CLOSED_ICON)
    device[CONF_TILT_LIFTED_ICON] = user_input.get(CONF_TILT_LIFTED_ICON, DEF_TILT_LIFTED_ICON)
